local: clean
	...
	sleep 20
	curl -X POST -d '{"args": [["amazon_reviews_us_Furniture_v1_00.tsv.gz", "amazon_reviews_us_Camera_v1_00.tsv.gz"]]}' http://localhost:5555/api/task/async-apply/ingester.tasks.task_dispacher
